package com.blogpost.hiro99ma.flfmt.util;
...
/**
 * A utility class that helps with showing and hiding system UI such as the status bar and navigation/system bar. This class uses backward-compatibility techniques described in <a href=
 * "http://developer.android.com/training/backward-compatible-ui/index.html"> Creating Backward-Compatible UIs</a> to ensure that devices running any version of ndroid OS are supported. More specifically, there are separate implementations of this
 * abstract class: for newer devices, {@link #getInstance} will return a {@link SystemUiHiderHoneycomb} instance, while on older devices {@link #getInstance} will return a {@link SystemUiHiderBase} instance.
 * <p>
...
public abstract class SystemUiHider {
	/**
	 * When this flag is set, the {@link android.view.WindowManager.LayoutParams#FLAG_LAYOUT_IN_SCREEN} flag will be set on older devices, making the status bar "float" on top of the activity layout. This is most useful when there are no controls at the
	 * top of the activity layout.
	 * <p>
	...
	/**
	 * When this flag is set, {@link #show()} and {@link #hide()} will toggle the visibility of the navigation bar, if it's present on the device and the device allows hiding it. In cases where the navigation bar is present but cannot be hidden, show and
